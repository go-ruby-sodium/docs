...
`go-ruby-sodium/sodium` reimplements Ruby's `sodium` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-sodium/sodium` directly, with no Ruby runtime;
