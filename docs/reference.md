...
The public API lives at the module root (`github.com/go-ruby-sodium/sodium`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `sodium`, while the surface follows
...
```go
import "github.com/go-ruby-sodium/sodium"
```
...
- **[pkg.go.dev/github.com/go-ruby-sodium/sodium](https://pkg.go.dev/github.com/go-ruby-sodium/sodium)**

The module's [README](https://github.com/go-ruby-sodium/sodium#readme) carries worked
